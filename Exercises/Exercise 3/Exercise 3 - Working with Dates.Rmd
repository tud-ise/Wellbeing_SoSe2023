---
title: "Exercise 3 - Working with Dates"
...
1.  Install the `lubridate` package by running `install.packages('lubridate')`
...
"POSIXct date-time object" (you can verify that with `is.instant(date)` or `class(date)`) that makes it very easy to work with it. For instance, you can find out which week the date refers to:
