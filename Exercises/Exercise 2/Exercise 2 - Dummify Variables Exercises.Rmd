---
title: "Exercise 2 - Dummify Variables Exercises"
...
\`df\$\`First Name\`\` or \`df[["First Name"]]\`. The backticks tell R
to treat everything inside them as a single entity, so the column name
